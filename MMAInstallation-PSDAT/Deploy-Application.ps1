...
Try {
	...
	[string]$appName = 'Microsoft Monitoring Agent'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	...
	[string]$appScriptAuthor = 'Thijs Lecomte'
	##*===============================================
	## Variables: Install Titles (Only set here to override defaults set by the toolkit)
	[string]$installName = 'The Collective Installation'
	[string]$installTitle = 'Microsoft Monitoring agent'
