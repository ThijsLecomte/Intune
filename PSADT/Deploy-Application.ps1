...
Try {
	...
	[string]$appScriptDate = '25/08/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        #Show-InstallationWelcome -CloseApps 'officeclicktorun,excel,groove,onenote,outlook,mspub,powerpnt,winword,iexplore,teams,visio' -Silent -CheckDiskSpace -PersistPrompt -AllowDefer -DeferTimes 3 
